	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header text-center">
				<h4 class="modal-title w-100 font-weight-bold">BOOK EVENT</h4>
				<button type="button" class="close" data-dismiss="modal"
					aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div><!-- regitereventservice -->
			<form:form action="#"
				modelAttribute="serviceEvent" name="eventFrm" onsubmit="return eventValid()" class="needs-validation">
				<div class="modal-body mx-3">
					<div class="md-form mb-5">
                        ...
                        <p data-error="wrong" data-success="right" class="invalid-feedback" id="eventName"></p>
					...
					<div class="md-form mb-5">
						...
						<label data-error="wrong" data-success="right"
							for="orangeForm-name">Mobile Number</label>
                        	  <p data-error="wrong" data-success="right" class="invalid-feedback" id="eventMobile"></p>	
					...
					<div class="md-form mb-5">
                      ...
                      <p data-error="wrong" data-success="right" class="invalid-feedback" id="eventEmail"></p>
					...
					<div class="md-form mb-5">
                       ...
                       <p data-error="wrong" data-success="right" class="invalid-feedback" id="eventEvent"></p>
					...
					<div class="md-form mb-5">
                     ...
                     <p data-error="wrong" data-success="right" class="invalid-feedback" id="eventAddress"></p>	
