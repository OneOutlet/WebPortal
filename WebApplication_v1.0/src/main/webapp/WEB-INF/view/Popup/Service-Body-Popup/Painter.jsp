	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header text-center">
				<h5 class="modal-title w-100 font-weight-bold">BOOK PAINTER</h5>
				<button type="button" class="close" data-dismiss="modal"
					aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<!-- regiterpainterservice -->
			<form:form action="regiterpainterservice"
				modelAttribute="servicePainter" name="painterFrm"
				onsubmit="return painterValid()" class="needs-validation">
				<div class="modal-body mx-3">
					<div class="md-form mb-3">
						...
						<p data-error="wrong" data-success="right"
							class="invalid-feedback" id="painterName"></p>
					...
					<div class="md-form mb-3">
						...
						<p data-error="wrong" data-success="right"
							class="invalid-feedback" id="painterMobile"></p>
					...
					<div class="md-form mb-3">
						...
						<p data-error="wrong" data-success="right"
							class="invalid-feedback" id="painterEmail"></p>
					...
					<div class="md-form mb-3">
						...
						<p data-error="wrong" data-success="right"
							class="invalid-feedback" id="painterAddress"></p>
